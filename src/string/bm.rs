...
pub fn generate_gs(pattern: &str) -> (Vec<i32>, Vec<bool>) {
    let m = pattern.len();
...
pub fn move_by_gs(bad_char_start_index: usize, pattern_len: usize, suffix: &Vec<i32>, prefix: &Vec<bool>) -> i32 {
    // 好后缀长度
...
pub fn bm_search(primary: &str, pattern: &str) -> i32 {
